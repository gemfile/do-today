...
import { secondsToMinutes } from '../components/util/TimeFormat';
...
export const startPomodoro = (todo: Object) => {
  makeSchedule( todo.index.toString(), 'complete!', new Date(Date.now() + (6 * 1000)) );
...
export const tickPomodoro = (todo: Object, secondsLeft: number) => {
  // console.log('tick', todo.index);
  notifyTick(todo.index.toString(), secondsToMinutes(secondsLeft));
